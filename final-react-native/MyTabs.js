...
export default function MyTabs() {
  ...
  useFocusEffect(
      React.useCallback(() => {
          webViewRef.current.injectJavaScript('location.href="' + 'https://www.camp-mo.site/' + '"');
          setLoading(false);
      }, [])
  );
...
//   useFocusEffect(
//       React.useCallback(() => {
//           webViewRef.current.injectJavaScript('location.href="' + 'http://13.209.252.229:8111/' + '"');
//           console.log("useFocusEffect : 13.209.252.229:8111");
//           setLoading(false);
//       }, [])
//   );
  ...
  return (
      <SafeAreaView style={styles.container}>
          <WebView
              ...
              source={{ uri: 'https://www.camp-mo.site/' }}
          />
